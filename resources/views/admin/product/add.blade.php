  ...
  <div class="row">
    <div class="col-6">
      ...
      <div class="form-group">
        ...
        <input type="number" name="pro_price" data-type="currency" class="form-control" >
      ...
      <div class="form-group">
        ...
        <input type="number" name="pro_price_sale" data-type="currency" class="form-control" >
      ...
      <div class="form-group">
        ...
        <input type="number" name="pro_total" class="form-control" >
    ...
    <div class="col-6">
      ...
      <div class="form-group">
        ...
        <textarea name="pro_desc" id="" cols="30" rows="4" class="form-control"></textarea>
      ...
      <div class="form-group">
        ...
        <textarea name="pro_detail" id="" cols="20" rows="6" class="form-control"></textarea>
